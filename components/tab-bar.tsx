...
export default function TabBar() {
  ...
  return (
    <div className="fixed bottom-0 mx-auto grid w-full max-w-xl grid-cols-5 border-t border-neutral-600 px-5 py-3 *:flex *:flex-col *:items-center *:gap-px *:text-white bg-neutral-800">
