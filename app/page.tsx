export default function Home() {
  return (
    <main className="flex h-screen items-center justify-center bg-gray-100 p-5 dark:bg-gray-700">
      <div className="w-full max-w-[640px] rounded-3xl bg-white p-5 shadow-lg dark:bg-gray-600">
        ...
        <div className="my-2 flex items-center gap-2">
          <span className="rounded-full bg-green-400 px-2.5 py-1.5 text-xs font-medium text-white uppercase transition hover:scale-110 hover:bg-green-500">
            Today
          </span>
